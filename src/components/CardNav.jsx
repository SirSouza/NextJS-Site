...
const CardNav = ({
  ...
  return (
    <div
      ...
      <nav
        ref={navRef}
        className={`card-nav ${isExpanded ? 'open' : ''} block h-15 p-0 rounded-xl shadow-[0px_0px_10px_-1px_rgba(255,255,255,0.5)] relative overflow-hidden will-change-[height]`}
        ...
        <div
          ...
          <div
            ...
            <h1 className='px-2.5 font-bold text-2xl'>Dev Anorak</h1>
          </div>
        </div>
